...
@section('content')
  ...
  <section class="architecture" id="architecture">
    <div class="architecture__inner">
      <div class="architecture__eyebrow reveal">The Architecture of Access</div>
  ...
  <section class="community" id="community">
    ...
    <div class="principles reveal-stagger">
  ...
  <section class="admission">
    <div class="admission__inner reveal">
