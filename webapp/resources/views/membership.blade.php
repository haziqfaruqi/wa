...
@section('content')
  ...
  <section class="hero">
    ...
    <div class="hero__inner">
      <div class="hero__card">
        <img src="/storage/media/hero2-membership.webp" alt="WomenAtlas Platinum Membership card">
      </div>
  ...
  <section class="why" id="learn">
    <div class="why__inner">
      <div class="why__copy reveal">
        <h2 class="why__title">Leadership <span class="it">Shouldn't</span> Be Built Alone.</h2>
        <p class="why__body">The most successful women don't grow because they work harder.<br>They grow because they surround themselves with the right people, opportunities, conversations, and visibility.</p>
        <p class="why__body">WomenAtlas Membership exists to connect ambitious women with a trusted community where leadership is strengthened through meaningful relationships, industry access, strategic learning, and real opportunities.</p>
        <p class="why__body">Because the right network doesn't just open doors.<br>It changes what's possible.</p>
        <p class="why__note">You don't need to know everyone.<br>You need to be in the right room.</p>
      </div>
      <div class="why__media reveal">
        <img src="/storage/media/masked.webp" alt="Women in a leadership discussion">
      </div>
    </div>
  </section>
  ...
  <section class="architecture" id="architecture">
    <div class="architecture__inner">
      <h2 class="architecture__title reveal">WomenAtlas Membership is <span class="it">built around depth.</span></h2>
      <p class="architecture__subtitle reveal">Participant will leave with greater confidence, clarity, and community.</p>
      <div class="architecture__grid reveal-stagger">
  ...
  <section class="community" id="community">
    ...
    <div class="principles">
      <div class="principles__grid reveal-stagger">
  ...
  <section class="apply" id="apply">
    <div class="apply__inner">
      <div class="apply__form reveal">
        ...
        <form class="apply__fields" method="POST" action="[[membership_application_url]]">
          <input type="hidden" name="_token" value="[[csrf_token]]">
          <div class="apply__row">
            <div class="apply__field">
              <label for="apply-first-name">First Name</label>
              <input type="text" id="apply-first-name" name="first_name" required autocomplete="given-name">
            </div>
            <div class="apply__field">
              <label for="apply-last-name">Last Name</label>
              <input type="text" id="apply-last-name" name="last_name" required autocomplete="family-name">
            </div>
          </div>
          <div class="apply__field">
          ...
          <div class="apply__field">
            ...
            <input type="tel" id="apply-phone" name="phone" placeholder="+60" autocomplete="tel">
          </div>
          <div class="apply__field">
            <label>Membership Plan</label>
            <div class="apply__plans">
              <label class="apply__plan"><input type="radio" name="plan" autocomplete="off" value="community" checked><span>Community</span></label>
              <label class="apply__plan"><input type="radio" name="plan" autocomplete="off" value="professional"><span>Professional</span></label>
              <label class="apply__plan"><input type="radio" name="plan" autocomplete="off" value="leadership"><span>Leadership</span></label>
            </div>
          </div>
          <label class="apply__agree"><input type="checkbox" name="terms" autocomplete="off" value="1" required> I agree to the <a href="/">Terms of Service</a></label>
          <button type="submit" class="apply__submit">Submit Application</button>
        </form>
      </div>
      <div class="apply__aside reveal">
        <img class="apply__aside-logo" src="/site/assets/logo-wa-mark.webp" alt="WomenAtlas">
